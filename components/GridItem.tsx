  ...
  return (
    ...
    >
        ...
        <div className="
            ...
            opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300 ease-[var(--ease-premium)]"
        ></div>
        {/* Image (thumbnail) */}
        <Image
            key={thisMediaIndex}
        ...
        >
            ...
            <div className="
                ...
                md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300 ease-[var(--ease-premium)]"
            >
                <div className="
